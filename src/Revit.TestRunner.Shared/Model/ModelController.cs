...
namespace Revit.TestRunner.Shared.Model
{
    public class ModelController
    {
        ...
        /// </summary>
        public NodeModel ToNodeTree( string exploreFile )
        {
            NodeModel root = null;
        ...
        private NodeModel ToNodeTree( NUnitTestRun run )
        {
        ...
        private void ToNode( NodeModel parent, NUnitTestSuite testSuite )
        {
